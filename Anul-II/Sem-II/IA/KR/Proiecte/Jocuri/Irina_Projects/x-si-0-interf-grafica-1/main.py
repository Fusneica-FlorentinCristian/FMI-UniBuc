			...
			for event in pygame.event.get():
				if event.type== pygame.QUIT:
					...
					for np in range(len(Joc.celuleGrid)):
						...
						if Joc.celuleGrid[np].collidepoint(pos):#verifica daca punctul cu coord pos se afla in rectangle(celula)
...
stare_curenta.game.display_game()
							elif stare_curenta.game.matr[np] == Joc.GOL:
								if de_mutat:
									#### eventuale teste legate de mutarea simbolului
									stare_curenta.game.matr[de_mutat[0] * 3 + de_mutat[1]]=Joc.GOL
									de_mutat=False		
								#plasez simbolul pe "tabla de joc"
								stare_curenta.game.matr[linie * 3 + coloana]=Joc.JMIN
