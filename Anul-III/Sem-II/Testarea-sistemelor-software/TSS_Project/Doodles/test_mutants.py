...
#
#
# def basic_original(target: str, genes: list[str], N_POPULATION, N_SELECTED, MUTATION_PROBABILITY, debug: bool = True) -> \
# tuple[int, int, str]:
#     # """
...
#     if N_POPULATION < 0 or N_SELECTED < 0:
#         raise ValueError("Both N_POPULATION and N_SELECTED must be > 0")
#     if MUTATION_PROBABILITY <= 0:
#         raise ValueError("MUTATION_PROBABILITY must be > 0")
#     # Verify that the target contains no genes besides the ones inside genes variable.
...
#
#
# def basic_mutant_1(target: str, genes: list[str], N_POPULATION, N_SELECTED, MUTATION_PROBABILITY, debug: bool = True) -> \
# tuple[int, int, str]:
#     # """
#     # Verify that the target contains no genes besides the ones inside genes variable.
#     #
...
#
#
# def basic_mutant_2(target: str, genes: list[str], N_POPULATION, N_SELECTED, MUTATION_PROBABILITY, debug: bool = True) -> \
# tuple[int, int, str]:
#     # """
#     # Verify that the target contains no genes besides the ones inside genes variable.
#     #
...
#
#
# def basic_mutant_3(target: str, genes: list[str], N_POPULATION, N_SELECTED, MUTATION_PROBABILITY, debug: bool = True) -> \
# tuple[int, int, str]:
#     # """
#     # Verify that the target contains no genes besides the ones inside genes variable.
#     #
...
#
#
# def basic_mutant_4(target: str, genes: list[str], N_POPULATION, N_SELECTED, MUTATION_PROBABILITY, debug: bool = True) -> \
# tuple[int, int, str]:
#     # """
#     # Verify that the target contains no genes besides the ones inside genes variable.
#     #
...
#
#
# def basic_mutant_5(target: str, genes: list[str], N_POPULATION, N_SELECTED, MUTATION_PROBABILITY, debug: bool = True) -> \
# tuple[int, int, str]:
#     # """
#     # Verify that the target contains no genes besides the ones inside genes variable.
#     #
...
#
#
# mutations_list = [basic_original, basic_mutant_1, basic_mutant_2, basic_mutant_3, basic_mutant_4, basic_mutant_5]
# test_list = getmembers(test_genetics, isfunction)[1:]  # all the tests in test_genetics as tuples of (funciton_name, function)
#
# test_list[1]()